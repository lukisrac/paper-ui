import { ToggleButton as ReactAriaToggleButton, ToggleButtonProps } from "react-aria-components";
...
export function ToggleButton(props: Props) {
    ...
    return (
        <ReactAriaToggleButton
            className={({ isDisabled, isFocusVisible, isFocused, isHovered, isPressed, isSelected }) =>
                cx(
                    "toggle-button",
                    `toggle-button--size-${size ?? "default"}`,
